...
* (May 2024) added Multivariate Noise Normalization ([paper](https://www.sciencedirect.com/science/article/abs/pii/S1053811918301411?via%3Dihub)), see [`mv_preprocess_mmn`](preprocess/mv_preprocess_mmn.m) and example 9 in [`understanding_spatial_filters`](https://github.com/treder/MVPA-Light/blob/master/examples/understanding_spatial_filters.m#L603-630)
