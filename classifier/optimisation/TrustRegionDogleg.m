function [w,iter,delta] = TrustRegionDogleg(X, YX, sumyxN, N,tolerance,max_iter,ll)
...
[f,J] = lr_gradient_and_hessian_tanh(w);
...
while iter < max_iter
    ...
    [f_new,J_new] = lr_gradient_and_hessian_tanh(w_new);
