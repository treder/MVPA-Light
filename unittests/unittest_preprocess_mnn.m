...
pparam = mv_get_preprocess_param('mnn');
pparam.target_dimension = [];
X2 = X(:, :, 1);
[pparam_out, ~] = mv_preprocess_mnn(pparam, X2, clabel);
...
pparam.target_dimension = [];
[pparam_out, ~] = mv_preprocess_mnn(pparam, X, clabel);
...
pparam = mv_get_preprocess_param('mnn');
pparam.target_dimension = 3;
[pparam_out, ~] = mv_preprocess_mnn(pparam, X2_train, clabel(1:20));
...
[pparam_out, X2_out] = mv_preprocess_mnn(pparam_out, X2_test, clabel(21:end));
