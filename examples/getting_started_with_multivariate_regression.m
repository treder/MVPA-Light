% GETTING STARTED WITH MULTIVARIATE REGRESSION
%
% This tutorial builds on the getting_started_with_regression tutorial so 
% make ure you have finished that one first. 
% 
%
% The purpose of this tutorial is to gain an understanding of multivariate
% regression. By multivariate regression we mean regression wherein both 
% features (aka predictors, aka independent variables) and targets (aka 
% response variable, aka dependent variables) are multi-dimensional.
% 
% Examples of multivariate regression methods are Canonical Correlation
% Analysis (CCA) and Partial Least Squared (PLS) regression. 
...
%% (1) Create two sets of simulated oscillatory EEG data
% Oscillatory data with narrowband oscillations and broadband data has been 
% introduced in understanding_spatial_filters. Refer to that tutorial for a
% basic explanation. Here, we create TWO sets of multivariate oscillatory
% signals that show some degree of phase-coupling between the sets. 
